...
package com.baidu.hugegraph.computer.core.store.bufferfile;
...
public class BufferFileSubEntryReader implements IterableEntryFile {
        ...
        public EntryIter() {
            try {
                ...
                throw new ComputerException(
                          "Failed to create BufferFileReader for:{}", e,
                          BufferFileSubEntryReader.this.file.getPath());
            }
        }
