...
public class IdTypeTest {
    ...
    @Test
    public void test() {
        Assert.assertEquals(new LongId(), IdType.createID(IdType.LONG));
        Assert.assertEquals(new Utf8Id(), IdType.createID(IdType.UTF8));
        Assert.assertEquals(new UuidId(), IdType.createID(IdType.UUID));
