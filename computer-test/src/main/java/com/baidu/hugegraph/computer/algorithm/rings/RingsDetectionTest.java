...
public class RingsDetectionTest extends UnitTestBase {

    private static final Logger LOG = Log.logger(RingsDetectionTest.class);
    ...
    public void test() throws InterruptedException {
        ...
        pool.submit(() -> {
            ...
            params.put(RpcOptions.RPC_REMOTE_URL.name(), "127.0.0.1:8190");
            params.put(ComputerOptions.JOB_ID.name(), "local_rings_1");
            ...
            params.put(ComputerOptions.BSP_MAX_SUPER_STEP.name(), "100");
            params.put(ComputerOptions.ALGORITHM_PARAMS_CLASS.name(),
                       RingsDetectionParams.class.getName());
        ...
        pool.submit(() -> {
            ...
            params.put(RpcOptions.RPC_SERVER_PORT.name(), "8190");
            params.put(ComputerOptions.JOB_ID.name(), "local_rings_1");
            params.put(ComputerOptions.JOB_WORKERS_COUNT.name(), "1");
            params.put(ComputerOptions.BSP_REGISTER_TIMEOUT.name(), "100000");
            params.put(ComputerOptions.BSP_LOG_INTERVAL.name(), "30000");
