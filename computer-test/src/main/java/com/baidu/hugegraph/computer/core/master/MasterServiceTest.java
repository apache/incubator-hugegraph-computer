...
import com.baidu.hugegraph.computer.core.worker.MockMasterComputation2;
...
public class MasterServiceTest extends UnitTestBase {

    private static final Logger LOG = Log.logger(MasterServiceTest.class);
